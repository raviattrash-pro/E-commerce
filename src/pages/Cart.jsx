      ...
      <div>
        ...
        <div className="p-3">
          ...
          <div className="flex items-center justify-between mt-4 mobile:flex-col">
            <button className="btn bg-white text-[#8a4af3] border-2 border-[#8a4af3] mt-0 hover:scale-[1.1] ease-in duration-300">
              Continue Shopping
            </button>
            ...
            <button className="btn mt-0 hover:scale-[1.1] ease-in duration-300">Checkout Now</button>
          </div>
            ...
            <div className="flex flex-col flex-1">
              ...
              <div className={ProductDivStyle}>
                <div className=" product flex pl-5 self-start">
                  <img
                    className="product_img w-[7rem] hover:scale-[1.1] ease-in duration-300"
